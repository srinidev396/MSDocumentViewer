...
namespace Leadtools.Demos
{
   ...
   public class DocumentConverterPreferences
   {
      ...
      // Run the conversion
      public bool Run(ObjectCache cache, LEADDocument document, DocumentConverter converter)
      {
      ...
      private void SetOptions(DocumentConverter converter, ObjectCache cache, LEADDocument document)
      {
         ...
         converter.Options.SvgImagesRecognitionMode = this.SvgImagesRecognitionMode;
